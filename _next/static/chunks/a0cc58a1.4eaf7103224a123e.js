    ...
    [3089], {
        2041: function(t, e) {
            ...
            d.initialize(), d.TKHD_FLAG_ENABLED = 1, d.TKHD_FLAG_IN_MOVIE = 2, d.TKHD_FLAG_IN_PREVIEW = 4, d.TFHD_FLAG_BASE_DATA_OFFSET = 1, d.TFHD_FLAG_SAMPLE_DESC = 2, d.TFHD_FLAG_SAMPLE_DUR = 8, d.TFHD_FLAG_SAMPLE_SIZE = 16, d.TFHD_FLAG_SAMPLE_FLAGS = 32, d.TFHD_FLAG_DUR_EMPTY = 65536, d.TFHD_FLAG_DEFAULT_BASE_IS_MOOF = 131072, d.TRUN_FLAGS_DATA_OFFSET = 1, d.TRUN_FLAGS_FIRST_FLAG = 4, d.TRUN_FLAGS_DURATION = 256, d.TRUN_FLAGS_SIZE = 512, d.TRUN_FLAGS_FLAGS = 1024, d.TRUN_FLAGS_CTS_OFFSET = 2048, d.Box.prototype.add = function(t) {
                ...
                return p < h ? (r.error("BoxParser", "Box of type " + l + " has an invalid size " + p + " (too small to be a box)"), {
                    code: d.ERR_NOT_ENOUGH_DATA,
                    type: l,
                    size: p,
                    hdr_size: h,
                    start: o
                }) : i && p > i ? (r.error("BoxParser", "Box of type '" + l + "' has a size " + p + " greater than its container size " + i), {
                    code: d.ERR_NOT_ENOUGH_DATA,
                    type: l,
                    size: p,
                    hdr_size: h,
                    start: o
                }) : o + p > t.getEndPosition() ? (t.seek(o), r.info("BoxParser", "Not enough data in stream to parse the entire '" + l + "' box"), {
                    code: d.ERR_NOT_ENOUGH_DATA,
                    type: l,
                    size: p,
                    hdr_size: h,
                ...
                if (this.hvcC) {
                    ...
                    e += d.decimalToHex(s, 0) + ".", 0 === this.hvcC.general_tier_flag ? e += "L" : e += "H", e += this.hvcC.general_level_idc;
                    var r = !1,
                        n = "";
                ...
                for (i in t)
                    if (!(d.DIFF_BOXES_PROP_NAMES.indexOf(i) > -1)) {
                        ...
                        if (void 0 === t[i] || void 0 === e[i] || "function" == typeof t[i] || "function" == typeof e[i] || t.subBoxNames && t.subBoxNames.indexOf(i.slice(0, 4)) > -1 || e.subBoxNames && e.subBoxNames.indexOf(i.slice(0, 4)) > -1 || "data" === i || "start" === i || "size" === i || "creation_time" === i || "modification_time" === i || d.DIFF_PRIMITIVE_ARRAY_PROP_NAMES.indexOf(i) > -1) continue;
                        if (t[i] !== e[i]) return !1
                    } return !0
            ...
            p.prototype.parseSample = function(t) {
                ...
                function r(t) {
                    ...
                    return "" + s(e, 2) + ":" + s(i, 2) + ":" + s(r, 2) + "." + s(Math.floor((t - 3600 * e - 60 * i - r) * 1e3), 3)
                }
            ...
            f.prototype.setSegmentOptions = function(t, e, i) {
                ...
                return !0
            }, f.prototype.lastBoxStartPosition = 0, f.prototype.parsingMdat = null, f.prototype.nextParsePosition = 0, f.prototype.discardMdatData = !1, f.prototype.processIncompleteBox = function(t) {
                var e;
            ...
            }, f.prototype.add = d.Box.prototype.add, f.prototype.addBox = d.Box.prototype.addBox, f.prototype.init = function(t) {
                var e = t || {};
                ...
                if (t.samples = [], t.samples_duration = 0, t.samples_size = 0, i = t.mdia.minf.stbl.stco || t.mdia.minf.stbl.co64, s = t.mdia.minf.stbl.stsc, r = t.mdia.minf.stbl.stsz || t.mdia.minf.stbl.stz2, n = t.mdia.minf.stbl.stts, a = t.mdia.minf.stbl.ctts, o = t.mdia.minf.stbl.stss, h = t.mdia.minf.stbl.stsd, d = t.mdia.minf.stbl.subs, u = t.mdia.minf.stbl.stdp, p = t.mdia.minf.stbl.sbgps, l = t.mdia.minf.stbl.sgpds, U = -1, S = -1, b = -1, x = -1, v = 0, w = 0, E = 0, f.initSampleGroups(t, null, p, l), void 0 !== r) {
                    for (e = 0; e < r.sample_sizes.length; e++) {
                        var e, i, s, r, n, a, o, h, d, p, l, u, c, _, m, g, y, U, S, b, x, v, w, E, B = {};
                        B.number = e, B.track_id = t.tkhd.track_id, B.timescale = t.mdia.mdhd.timescale, B.alreadyRead = 0, t.samples[e] = B, B.size = r.sample_sizes[e], t.samples_size += B.size, 0 === e ? (_ = 1, c = 0, B.chunk_index = _, B.chunk_run_index = c, y = s.samples_per_chunk[c], g = 0, m = c + 1 < s.first_chunk.length ? s.first_chunk[c + 1] - 1 : 1 / 0) : e < y ? (B.chunk_index = _, B.chunk_run_index = c) : (_++, B.chunk_index = _, g = 0, _ <= m || (m = ++c + 1 < s.first_chunk.length ? s.first_chunk[c + 1] - 1 : 1 / 0), B.chunk_run_index = c, y += s.samples_per_chunk[c]), B.description_index = s.sample_description_index[B.chunk_run_index] - 1, B.description = h.entries[B.description_index], B.offset = i.chunk_offsets[B.chunk_index - 1] + g, g += B.size, e > U && (S++, U < 0 && (U = 0), U += n.sample_counts[S]), e > 0 ? (t.samples[e - 1].duration = n.sample_deltas[S], t.samples_duration += t.samples[e - 1].duration, B.dts = t.samples[e - 1].dts + t.samples[e - 1].duration) : B.dts = 0, a ? (e >= b && (x++, b < 0 && (b = 0), b += a.sample_counts[x]), B.cts = t.samples[e].dts + a.sample_offsets[x]) : B.cts = B.dts, o ? (e == o.sample_numbers[v] - 1 ? (B.is_sync = !0, v++) : (B.is_sync = !1, B.degradation_priority = 0), d && d.entries[w].sample_delta + E == e + 1 && (B.subsamples = d.entries[w].subsamples, E += d.entries[w].sample_delta, w++)) : B.is_sync = !0, f.process_sdtp(t.mdia.minf.stbl.sdtp, B, B.number), u ? B.degradation_priority = u.priority[e] : B.degradation_priority = 0, d && d.entries[w].sample_delta + E == e && (B.subsamples = d.entries[w].subsamples, E += d.entries[w].sample_delta), (p.length > 0 || l.length > 0) && f.setSampleGroupProperties(t, B, e, t.sample_groups_info)
                    }
                    ...
                    for (; this.lastMoofIndex < this.moofs.length;)
                        if (h = this.moofs[this.lastMoofIndex], this.lastMoofIndex++, "moof" == h.type)
                            for (t = 0; t < h.trafs.length; t++) {
                                for (p = h.trafs[t], l = this.getTrackById(p.tfhd.track_id), u = this.getTrexById(p.tfhd.track_id), s = p.tfhd.flags & d.TFHD_FLAG_SAMPLE_DESC ? p.tfhd.default_sample_description_index : u ? u.default_sample_description_index : 1, r = p.tfhd.flags & d.TFHD_FLAG_SAMPLE_DUR ? p.tfhd.default_sample_duration : u ? u.default_sample_duration : 0, n = p.tfhd.flags & d.TFHD_FLAG_SAMPLE_SIZE ? p.tfhd.default_sample_size : u ? u.default_sample_size : 0, a = p.tfhd.flags & d.TFHD_FLAG_SAMPLE_FLAGS ? p.tfhd.default_sample_flags : u ? u.default_sample_flags : 0, p.sample_number = 0, p.sbgps.length > 0 && f.initSampleGroups(l, p, p.sbgps, l.mdia.minf.stbl.sgpds, p.sgpds), e = 0; e < p.truns.length; e++) {
                                    var t, e, i, s, r, n, a, o, h, p, l, u, c, _, m = p.truns[e];
                                    for (i = 0; i < m.sample_count; i++) {
                                        (c = {}).moof_number = this.lastMoofIndex, c.number_in_traf = p.sample_number, p.sample_number++, c.number = l.samples.length, p.first_sample_index = l.samples.length, l.samples.push(c), c.track_id = l.tkhd.track_id, c.timescale = l.mdia.mdhd.timescale, c.description_index = s - 1, c.description = l.mdia.minf.stbl.stsd.entries[c.description_index], c.size = n, m.flags & d.TRUN_FLAGS_SIZE && (c.size = m.sample_size[i]), l.samples_size += c.size, c.duration = r, m.flags & d.TRUN_FLAGS_DURATION && (c.duration = m.sample_duration[i]), l.samples_duration += c.duration, l.first_traf_merged || i > 0 ? c.dts = l.samples[l.samples.length - 2].dts + l.samples[l.samples.length - 2].duration : (p.tfdt ? c.dts = p.tfdt.baseMediaDecodeTime : c.dts = 0, l.first_traf_merged = !0), c.cts = c.dts, m.flags & d.TRUN_FLAGS_CTS_OFFSET && (c.cts = c.dts + m.sample_composition_time_offset[i]), _ = a, m.flags & d.TRUN_FLAGS_FLAGS ? _ = m.sample_flags[i] : 0 === i && m.flags & d.TRUN_FLAGS_FIRST_FLAG && (_ = m.first_sample_flags), c.is_sync = !(_ >> 16 & 1), c.is_leading = _ >> 26 & 3, c.depends_on = _ >> 24 & 3, c.is_depended_on = _ >> 22 & 3, c.has_redundancy = _ >> 20 & 3, c.degradation_priority = 65535 & _;
                                        var g = !!(p.tfhd.flags & d.TFHD_FLAG_BASE_DATA_OFFSET),
                                            ...
                                            S = 0;
                                        S = g ? p.tfhd.base_data_offset : y ? h.start : 0 === e ? h.start : o, 0 === e && 0 === i ? U ? c.offset = S + m.data_offset : c.offset = S : c.offset = o, o = c.offset + c.size, (p.sbgps.length > 0 || p.sgpds.length > 0 || l.mdia.minf.stbl.sbgps.length > 0 || l.mdia.minf.stbl.sgpds.length > 0) && f.setSampleGroupProperties(l, c, c.number_in_traf, p.sample_groups_info)
                                    }
                                }
                                if (p.subs) {
                                    l.has_fragment_subsamples = !0;
                                    var b = p.first_sample_index;
                                    for (e = 0; e < p.subs.entries.length; e++) b += p.subs.entries[e].sample_delta, (c = l.samples[b - 1]).subsamples = p.subs.entries[e].subsamples
                                }
                            }
                }
            ...
            }, f.writeInitializationSegment = function(t, e, i, s) {
                ...
                for (null === this.onSegment && r.warn("MP4Box", "No segmentation callback set!"), this.isFragmentationInitialized || (this.isFragmentationInitialized = !0, this.nextMoofNumber = 0, this.resetTables()), e = [], t = 0; t < this.fragmentedTracks.length; t++) {
                    ...
                    n.mvhd = this.moov.mvhd, n.boxes.push(n.mvhd), i = this.getTrackById(this.fragmentedTracks[t].id), n.boxes.push(i), n.traks.push(i), (s = {}).id = i.tkhd.track_id, s.user = this.fragmentedTracks[t].user, s.buffer = f.writeInitializationSegment(this.ftyp, n, this.moov.mvex && this.moov.mvex.mehd ? this.moov.mvex.mehd.fragment_duration : void 0, this.moov.traks[t].samples.length > 0 ? this.moov.traks[t].samples[0].duration : 0), e.push(s)
                }
                return e

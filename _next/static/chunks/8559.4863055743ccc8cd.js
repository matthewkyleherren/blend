      ...
      var n = t(5893),
        ...
        v = (e) => {
          let { loop: r, src: t } = e,
            ...
            _ = (0, i.useRef)(!1),
            q = (0, a.LZ)(),
            O = (0, g.a)("(max-width: 1024px)"),
            X = (0, c.o)((e) => e.isPopupOpen),
            $ = (0, c.o)((e) => e.setPopupOpen),
            Y = (0, c.o)((e) => e.setHeaderVisible),
            D = (0, c.o)((e) => e.isAppear);
          z.current = X;
          let K = () => {
              z.current
                ...
                : ((_.current =
                    ...
                    W.current.getBoundingClientRect().top +
          ...
          ((0, i.useEffect)(
            () => (
              ...
              o.current.addEventListener("playing", () => {
                F.current &&
                  ((F.current = !1), j.current.classList.add("opacity-0"));
              }),
              ...
              () => {
                (window.removeEventListener("resize", K),
                  ...
                  o.current &&
                    o.current.removeEventListener("fullscreenchange", G));
              }
            ),
            [],
          ),
            (0, i.useEffect)(
              () => (
                X
                  ? ((S.current = u.Z.add(eo, 0)),
                    C.current ? en() : ((C.current = !0), Q().then(() => en())))
                  : el(),
                () => {
          ...
          let J = () => {
            ...
            en = () => {
              ...
              (q && q.stop(),
                ...
                W.current.classList.remove("group"),
                W.current.classList.add("pointer-events-none"),
                b.current.classList.remove("pointer-events-none"),
                er(),
                (0, w.RE)(B.current),
                (H.current = l.p8.timeline({
                  defaults: {
                    ease: "expo.out",
                    duration: 1.2,
                  },
                })),
                H.current.addLabel("start", 0),
                H.current
                  .to(
                    [M.current, I.current],
                    {
            ...
            el = () => {
              O ||
                ...
                W.current.classList.add("group"),
                W.current.classList.remove("pointer-events-none"),
                b.current.classList.add("pointer-events-none"),
                et(),
                (0, w.RE)(H.current),
                (B.current = l.p8.timeline({
                  defaults: {
                    ease: "expo.out",
                    duration: 0.9,
                  },
                ...
                (0, n.jsxs)("div", {
                  ...
                  children: [
                    ...
                    (0, n.jsx)("div", {
                      ref: I,
                      className:
                        "absolute bottom-0 right-0 w-full h-full bg-white rounded-12 overflow-hidden",
        ...
        L = (e) => {
          let { item: r, items: t, index: a } = e,
            ...
            z = (0, i.useRef)(null),
            H = (0, i.useRef)(null),
            B = (0, g.a)("(max-width: 1200px)", !0),
            [P, S] = (0, i.useState)(0),
            [W, T] = (0, i.useState)(0),
            [M, I] = (0, i.useState)(!0),
            A = (0, c.o)((e) => e.isPopupOpen),
            V = (0, c.o)((e) => e.isLoaded),
            Z = (0, c.o)((e) => e.isFirstLoaded),
            _ = (0, c.o)((e) => e.isAppear),
            q = (0, c.o)((e) => e.animationContext),
            O = (0, c.o)((e) => e.setCursorHidden),
            X = () => {
            ...
            Q = () => {
              l.p8.timeline().fromTo(
                [k.current, F.current, C.current],
                {
                  scale: 1.2,
                },
                {
          ...
          return (
            ...
            (0, i.useEffect)(
              () => (
                ...
                J(),
                G(),
                N.current && N.current.addEventListener("play", X),
                (m.current.style.zIndex = 10),
                  ...
                  (0, n.jsx)("div", {
                    ...
                    children: (0, n.jsxs)("div", {
                      ...
                      children: [
                        (0, n.jsx)("div", {
                          className: "".concat(
                            r.displayLiveEvent && "hidden md:block",
                        ...
                        (0, n.jsx)("div", {
                          ref: C,
                          className:
                            "absolute left-0 top-0 w-full h-full z-3 pointer-events-none nodisplay",
                          children:
                            r.middleImage.data &&
                            (0, n.jsx)("div", {
                              className:
                        ...
                        (0, n.jsx)("div", {
                          ...
                          children: (0, n.jsxs)("div", {
                            ...
                            children: [
                              (0, n.jsx)("div", {
                                className:
                                  "lg:hidden text-dark_grey text-center overflow-hidden w-[110%] -ml-[5%] pb-[10px]",
                              ...
                              (0, n.jsx)("div", {
                                className:
                                  "hidden lg:block text-dark_grey text-center overflow-hidden top10pad",
                                children: r.title.split("\n").map((e, r) =>
                                  (0, n.jsx)(
                                    "span",
                                    {
                          ...
                          children: [
                            (0, n.jsx)("video", {
                              ...
                              children: (0, n.jsx)("source", {
                                ...
                                src: E.$N(
                                  r.foregroundVideo.data.attributes.url,
                                ),
                              }),
                            }),
                            r.foregroundImage.data &&
                              (0, n.jsx)("div", {
                                ref: L,
                                className:
                          ...
                          children: [
                              ...
                              (0, n.jsx)("div", {
                                className:
                                  "flex justify-end col-start-1 col-end-5 md:col-start-5 md:col-end-7 lg:col-start-6 lg:col-end-8 xl:col-start-8 xl:col-end-10 ".concat(
                                    r.video.data && r.previewVideoLoop.data
                            ...
                            r.video.data &&
                              ...
                              (0, n.jsx)("div", {
                                ...
                                children: (0, n.jsx)(v, {
                                  loop: E.$N(
                                    r.previewVideoLoop.data.attributes.url,
                                  ),

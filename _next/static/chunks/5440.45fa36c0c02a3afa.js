        ...
        5440: function(e, r, t) {
            ...
            r.default = e => {
                ...
                return (0, l.jsx)("section", {
                    ...
                    className: "relative",
                    children: c ? (0, l.jsx)(h, {
                        item: r
                    }) : !r.showOnMobile && (0, l.jsx)(p, {
                        item: r
                    })
                })
            };
            let h = e => {
                    let {
                        item: r
                    } = e, t = (0, a.useRef)(null), n = (0, a.useRef)(null), o = (0, a.useRef)([]), u = (0, a.useRef)([]), h = (0, a.useRef)([0, 0, 0]), p = (0, a.useRef)([0, 0, 0]), x = (0, a.useRef)([]), b = (0, a.useRef)([]), w = (0, a.useRef)([]), v = (0, a.useRef)(null), j = (0, a.useRef)(null), y = (0, a.useRef)([]), k = e => {
                        ...
                        if (p.current[e] = r, p.current[e] != h.current[e]) {
                            for (let t = 0; t < o.current[e].length; t++) o.current[e][t].classList.toggle("a", t === r);
                            c.p8.set(u.current[e][p.current[e]], {
                                zIndex: v.current++
                            }), c.p8.fromTo(u.current[e][p.current[e]], {
                                autoAlpha: 0
                            }, {
                                autoAlpha: 1,
                                duration: .5,
                ...
                x = e => {
                    let {
                        item: r,
                        scrollTo: n
                    } = e, u = (0, a.useRef)(null), h = (0, a.useRef)([]), p = (0, a.useRef)([]), x = (0, a.useRef)([]), b = (0, a.useRef)([]), w = (0, a.useRef)([]), v = (0, a.useRef)([]), j = (0, a.useRef)([]), y = (0, a.useRef)([]), k = (0, a.useRef)([]), N = (0, a.useRef)([0, 0, 0]), R = (0, a.useRef)([0, 0, 0]), C = (0, a.useRef)(0), _ = (0, a.useRef)(0), z = (0, a.useRef)(null), E = (0, a.useRef)(null), A = (0, a.useRef)(null), T = (0, a.useRef)([]), B = (0, a.useRef)([]), H = (0, a.useRef)([]), L = (0, a.useRef)([]), I = (0, a.useRef)(null), P = (0, a.useRef)([]), S = (0, a.useRef)([]), M = (0, a.useRef)(null), W = (0, a.useRef)(null), Z = e => {
                        B.current[e] && !B.current[e].paused && B.current[e].pause()
                    }, F = e => {
                        ...
                        (0, o.RE)(S.current[e]);
                        let r = [p.current[e], x.current[e], b.current[e]];
                        ...
                        for (let r = 0; r < h.current.length; r++) e.push(h.current[r].offsetHeight);
                        c.p8.set(E.current, {
                            height: Math.max(...e)
                    ...
                    return (0, a.useEffect)(() => {
                        ...
                        Y(), U(), O();
                        for (let e = 1; e < h.current.length; e++) b.current[e] && c.p8.set(b.current[e], {
                            autoAlpha: 0
                        }), p.current[e] && c.p8.set(p.current[e], {
                            autoAlpha: 0
